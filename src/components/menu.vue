<template>
  ...
  >
    ...
    <button
      ...
      class="text-xl p-2 border border-white hover:bg-white hover:text-black"
    >
      Confirm
    </button>
  </div>
  ...
  >
    ...
    <button
      ...
      class="text-xl p-2 border-2 border-white hover:bg-white hover:text-black mb-3"
    >
      Local game
    </button>
    <button
      @click="openModal"
      class="text-xl p-2 border-2 border-white hover:bg-white hover:text-black"
    >
      Multiplayer
    </button>
  </div>
